...
from checkin.views import UserCreateView, IndexView, ChildCreateView, DayCreateView, ChildDetailView, DayUpdateView
...
urlpatterns = [
    ...
    url(r'^child/(?P<pk>\d+)/update$', DayUpdateView.as_view(), name="child_update_view")
]
